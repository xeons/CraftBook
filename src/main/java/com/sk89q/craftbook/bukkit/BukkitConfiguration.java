...
public class BukkitConfiguration {
    ...
    public void load() {
        ...
        if (config.getNode("mechanics") != null) {
            ...
            new File(CraftBookPlugin.inst().getDataFolder(), "config.yml")
                    .renameTo(new File(CraftBookPlugin.inst().getDataFolder(), "config.yml.old"));
            CraftBookPlugin.inst().createDefaultConfiguration(
                    new File(CraftBookPlugin.inst().getDataFolder(), "config.yml"), "config.yml");
            try {
                config.load();
            } catch (IOException e) {
                e.printStackTrace();
        ...
        config.setHeader(
                "# CraftBook Configuration for Bukkit. Generated for version: " + (CraftBookPlugin.inst() == null
        ...
        config.setComment("enabled-mechanics",
        ...
        config.setComment("disabled-mechanics",
        ...
        config.setComment("st-think-ticks",
        ...
        config.setComment("safe-destruction",
        ...
        config.setComment("indirect-redstone",
        ...
        config.setComment("check-worldguard-flags",
        ...
        config.setComment("advanced-block-checks",
        ...
        config.setComment("pedantic-block-checks",
        ...
        config.setComment("scan-text-for-localization",
        ...
        config.setComment("debug-mode-file-logging",
        ...
        config.setComment("show-permission-messages",
        ...
        config.setComment("persistent-storage-type",
        ...
        config.setComment("convert-names-to-cbids",
