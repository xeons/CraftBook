...
public enum ClickType {
    ...
    CLICK_LEFT, CLICK_RIGHT, CLICK_EITHER, CLICK_LEFT_BLOCK, CLICK_RIGHT_BLOCK, CLICK_EITHER_BLOCK, CLICK_LEFT_AIR, CLICK_RIGHT_AIR, CLICK_EITHER_AIR, ENTITY_RIGHT, ENTITY_LEFT, ENTITY_ARROW, ENTITY_PROJECTILE, ENTITY_EITHER, BLOCK_BREAK, BLOCK_PLACE, BLOCK_PROJECTILE_AIR, BLOCK_PROJECTILE_BLOCK, BLOCK_PROJECTILE_EITHER, PROJECTILE_LAUNCH, BLOCK_EITHER, ITEM_CONSUME, ITEM_DROP, ITEM_BREAK, ITEM_PICKUP, ITEM_CLICK_LEFT, ITEM_CLICK_RIGHT, ITEM_CLICK_EITHER, PLAYER_DEATH, PLAYER_CHAT, PASSIVE, ANY;
    ...
    public boolean doesPassType(Event event) {
        ...
        switch (this) {
            ...
            case BLOCK_PROJECTILE_AIR :
                return event instanceof ProjectileHitEvent
                        && ((ProjectileHitEvent) event).getEntity().getLocation().getBlock().getType() == Material.AIR;
            ...
            case CLICK_EITHER :
                return event instanceof PlayerInteractEvent
                        && ((PlayerInteractEvent) event).getAction() != Action.PHYSICAL;
            case CLICK_LEFT :
                return event instanceof PlayerInteractEvent
                        && (((PlayerInteractEvent) event).getAction() == Action.LEFT_CLICK_AIR
                                || ((PlayerInteractEvent) event).getAction() == Action.LEFT_CLICK_BLOCK);
            case CLICK_RIGHT :
                return event instanceof PlayerInteractEvent
