...
public class LightStone extends AbstractCraftBookMechanic {
    ...
    public void onRightClick(PlayerInteractEvent event) {
        ...
        player.printRaw(ChatColor.YELLOW + player.translate("mech.lightstone.lightstone") + " ["
                + getLightLine(block.getLightLevel()) + ChatColor.YELLOW + "] " + block.getLightLevel() + " L");
    }
    ...
    public void loadConfiguration(YAMLProcessor config, String path) {
        ...
        item = BukkitAdapter.asItemType(
                ItemSyntax.getItem(config.getString(path + "item", ItemTypes.GLOWSTONE_DUST.id())).getType());
    }
}
