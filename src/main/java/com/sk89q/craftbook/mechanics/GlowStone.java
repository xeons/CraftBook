...
public class GlowStone extends AbstractCraftBookMechanic {
    ...
    public void onBlockRedstoneChange(SourcedBlockRedstoneEvent event) {
        ...
        if (!offBlock.equalsFuzzy(BukkitAdapter.adapt(event.getBlock().getBlockData()))
    ...
    public void loadConfiguration(YAMLProcessor config, String path) {
        ...
        config.setComment(path + "glowstone-off-block",
                "Sets the block that the redstone glowstone mechanic turns into when turned off.");
