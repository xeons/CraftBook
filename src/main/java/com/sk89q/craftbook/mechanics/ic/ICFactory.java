...
public interface ICFactory {
    ...
    /**
     * Create an IC instance given a block. The verify method should already have been called before this function, so
     * this should have no reason to fail or return a null.
     *
     * @param sign
     *
     ...
     * This does NOT verify permissions, since that is only done when placing blocks for a new IC, and this can be
     * invoked many times in the life of an IC.
     *
     * @param sign
     *
     * @throws ICVerificationException if the area of the world defined by the sign does not represent a valid setup for
     *         this type of IC.
     */
     ...
     * permission can't message others or the whole server.
     *
     * @param sign
     * @param player
     *
     ...
     *
     * This description must fit the guidelines of MediaWiki syntax, as it is built to work on a wiki running MediaWiki.
     *
