...
public abstract class AbstractIC implements IC {
    ...
    public void onRightClick(Player p) {
        ...
        if (p.isSneaking()) {
            ICDocsParser.generateICDocs(p, RegexUtil.RIGHT_BRACKET_PATTERN
                    .split(RegexUtil.LEFT_BRACKET_PATTERN.split(getSign().getLine(1))[1])[0]);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return o instanceof AbstractIC && getSignTitle().equalsIgnoreCase(((AbstractIC) o).getSignTitle())
                && getTitle().equalsIgnoreCase(((AbstractIC) o).getTitle()) && sign.equals(((AbstractIC) o).sign);
